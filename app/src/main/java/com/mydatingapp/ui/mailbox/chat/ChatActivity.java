package com.mydatingapp.ui.mailbox.chat;
...
import com.mydatingapp.ui.mailbox.MailboxPingHandler;
import com.mydatingapp.ui.mailbox.attachment_viewer.AttachmentHelper;
import com.mydatingapp.ui.mailbox.compose.Recipient;
import com.mydatingapp.ui.mailbox.conversation_list.MailboxFragment;
import com.mydatingapp.ui.mailbox.chat.ui.ConversationHistoryAdapter;
import com.mydatingapp.ui.mailbox.Constants;
...
import com.mydatingapp.ui.mailbox.chat.model.DailyHistory;
import com.mydatingapp.ui.memberships.SubscribeOrBuyActivity;
import com.mydatingapp.utils.SKPopupMenu;
import com.mydatingapp.utils.SKRoundedImageView;
    ...
    public void showChooseDialog() {
        ...
        myAlertDialog.setPositiveButton(R.string.mailbox_attachment_dialog_gallery, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                ...
                ChatActivity.this.startActivityForResult(Intent.createChooser(galleryIntent, getString(R.string.mailbox_attachment_dialog_select_app)), GALLERY_RESULT);
            }
        });
