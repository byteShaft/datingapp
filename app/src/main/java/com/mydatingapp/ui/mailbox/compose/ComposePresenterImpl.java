    ...
    public void attachmentClick() {
        ...
        myAlertDialog.setPositiveButton(R.string.mailbox_attachment_dialog_gallery, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                ...
                mComposeView.startActivity(Intent.createChooser(galleryIntent, mComposeView.getContext().getString(R.string.mailbox_attachment_dialog_select_app)), GALLERY_RESULT);
            }
        });
        ...
        switch ( requestCode ) {
            case GALLERY_RESULT:
                if ( data != null && data.getData() != null ) {
                    ...
                    if ( !file.exists() ) {
                        Cursor cursor = mComposeView.getCursor(uri);
                        cursor.moveToFirst();
