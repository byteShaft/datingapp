package com.mydatingapp.ui.speedmatch.fragments;
...
import com.mydatingapp.utils.form.AgeRangeField;
import com.mydatingapp.utils.form.MultiCheckboxDialogField;
import com.mydatingapp.utils.form.SingleRangeField;
...
public class SpeedmatchesFilterFragment extends PreferenceFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        matchAgeField.setValue(((String)this.settings.get("matchAge")));
        matchAgeField.setRange(18, 100);

        getPreferenceScreen().addPreference(matchAgeField);

        String[] distaceRange = {"5", "25", "50", "100"};
        SingleRangeField distanceField = new SingleRangeField(getActivity());
        distanceField.setTitle(R.string.speedmatches_filter_distance);
        distanceField.setDialogLabel(getResources().getString(R.string.speedmatches_filter_distance));
