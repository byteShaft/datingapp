...
package com.mydatingapp.core.sqlite;
...
import com.mydatingapp.model.base.CacheProvider;
import com.mydatingapp.model.base.MainMenuProvider;
...
public class SQLiteContentProvider extends ContentProvider {
    ...
    private static final String DATABASE_NAME = "skadatexapp.db";

    private static final int DATABASE_VERSION = 1;

    private static final String MIME_DIR = "skadatexapp.cursor.dir/";

    private static final String MIME_ITEM = "skadatexapp.cursor.item/";

    private static final Map<String, SQLiteTableProvider> SCHEMA = new ConcurrentHashMap<>();

    static {
        SCHEMA.put(CacheProvider.TABLE_NAME, new CacheProvider());
        SCHEMA.put(MainMenuProvider.TABLE_NAME, new MainMenuProvider());
    }
